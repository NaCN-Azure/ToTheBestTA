  ...
  extends ContentProvider
{
    ...
    implements FileProvider.PathStrategy
  {
    ...
    public File getFileForUri(Uri paramUri)
    {
      ...
      //   0	179	0	this	SimplePathStrategy
      //   0	179	1	paramUri	Uri
      //   4	21	2	str1	String
      //   12	16	3	i	int
      //   22	19	4	str2	String
      //   34	65	5	str3	String
      //   48	70	6	localFile1	File
      //   62	22	7	localStringBuilder1	StringBuilder
      //   103	58	10	localFile2	File
      //   141	1	11	localIOException	IOException
      //   148	23	11	localStringBuilder2	StringBuilder
      //   110	29	14	localFile3	File
      // Exception table:
      //   from	to	target	type
    ...
    public Uri getUriForFile(File paramFile)
    {
      ...
      // Local variable table:
      //   start	length	slot	name	signature
      //   0	322	0	this	SimplePathStrategy
      //   0	322	1	paramFile	File
      //   296	19	2	localStringBuilder1	StringBuilder
      //   4	240	5	str1	String
      //   7	278	6	localObject	Object
      //   21	196	7	localIterator	java.util.Iterator
      //   226	57	8	localEntry	java.util.Map.Entry
      //   241	18	9	str2	String
      //   45	23	10	localStringBuilder2	StringBuilder
      //   89	33	13	str3	String
      //   106	22	14	i	int
      //   289	1	14	localIOException	IOException
      //   115	56	15	str4	String
      //   139	43	16	localStringBuilder3	StringBuilder
      //   186	22	20	str5	String
      // Exception table:
      //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\android\content\FileProvider.class
