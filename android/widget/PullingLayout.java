  ...
  extends RelativeLayout
{
  ...
  Handler a = new Handler()
  {
    ...
    {
      PullingLayout.this.MOVE_SPEED = ((float)(8.0D + 5.0D * Math.tan(1.5707963267948966D / PullingLayout.this.getMeasuredHeight() * (PullingLayout.this.pullDownY + Math.abs(PullingLayout.a(PullingLayout.this))))));
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\android\widget\PullingLayout.class
