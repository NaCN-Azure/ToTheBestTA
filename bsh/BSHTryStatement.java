  ...
  extends SimpleNode
{
  ...
  public Object eval(CallStack paramCallStack, Interpreter paramInterpreter)
  {
    ...
    //   0	511	0	this	BSHTryStatement
    //   0	511	1	paramCallStack	CallStack
    //   0	511	2	paramInterpreter	Interpreter
    //   1	286	3	i	int
    //   10	116	4	localBSHBlock1	BSHBlock
    //   19	183	5	localVector1	java.util.Vector
    //   28	257	6	localVector2	java.util.Vector
    //   34	10	7	j	int
    //   37	46	8	k	int
    //   58	49	9	localNode	Node
    //   111	316	10	localBSHBlock2	BSHBlock
    //   123	34	11	m	int
    //   139	1	12	localObject1	Object
    //   144	24	12	localTargetError	TargetError
    //   394	47	12	localObject2	Object
    //   148	359	13	str	String
    //   465	37	14	localStringBuffer	StringBuffer
    //   136	316	19	localObject3	Object
    //   172	109	20	localThrowable1	Throwable
    //   190	6	21	n	int
    //   210	144	22	localBSHFormalParameter	BSHFormalParameter
    //   269	90	24	localThrowable2	Throwable
    //   293	85	25	localBSHBlock3	BSHBlock
    //   299	104	26	localNameSpace	NameSpace
    //   310	62	27	localBlockNameSpace	BlockNameSpace
    //   274	1	28	localUtilEvalError1	UtilEvalError
    //   411	1	29	localUtilEvalError2	UtilEvalError
    //   399	10	30	localObject4	Object
    //   132	3	33	localObject5	Object
    //   50	38	34	i1	int
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\bsh\BSHTryStatement.class
