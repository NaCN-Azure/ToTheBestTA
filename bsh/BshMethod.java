  ...
  implements Serializable
{
    ...
    for (;;)
    {
      ...
      if (arrayOfClass[k] != null)
      {
        try
        {
          ...
          if (paramArrayOfObject[k] != Primitive.VOID) {
            break label602;
          }
        }
  ...
  Object a(Object[] paramArrayOfObject, Interpreter paramInterpreter, CallStack paramCallStack, SimpleNode paramSimpleNode, boolean paramBoolean)
  {
    ...
    //   0	233	0	this	BshMethod
    //   0	233	1	paramArrayOfObject	Object[]
    //   0	233	2	paramInterpreter	Interpreter
    //   0	233	3	paramCallStack	CallStack
    //   0	233	4	paramSimpleNode	SimpleNode
    //   0	233	5	paramBoolean	boolean
    //   213	6	7	localObject2	Object
    //   205	6	8	localObject3	Object
    //   86	22	9	localReflectError	ReflectError
    //   95	23	10	localStringBuffer	StringBuffer
    //   64	9	13	localInvocationTargetException	java.lang.reflect.InvocationTargetException
    //   81	3	14	localTargetError	TargetError
    //   59	3	15	localObject4	Object
    //   170	1	15	localUtilEvalError	UtilEvalError
    //   5	30	16	k	int
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\bsh\BshMethod.class
