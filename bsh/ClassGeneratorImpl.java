  ...
  extends ClassGenerator
{
  ...
  public static Class generateClassImpl(String paramString, Modifiers paramModifiers, Class[] paramArrayOfClass, Class paramClass, BSHBlock paramBSHBlock, boolean paramBoolean, CallStack paramCallStack, Interpreter paramInterpreter)
  {
    ...
    //   0	563	0	paramString	String
    //   0	563	1	paramModifiers	Modifiers
    //   0	563	2	paramArrayOfClass	Class[]
    //   0	563	3	paramClass	Class
    //   0	563	4	paramBSHBlock	BSHBlock
    //   0	563	5	paramBoolean	boolean
    //   0	563	6	paramCallStack	CallStack
    //   0	563	7	paramInterpreter	Interpreter
    //   9	335	8	localNameSpace1	NameSpace
    //   16	210	9	str1	String
    //   33	29	10	localStringBuffer1	StringBuffer
    //   66	149	14	str2	String
    //   93	27	15	localStringBuffer2	StringBuffer
    //   81	130	19	str3	String
    //   131	367	20	localBshClassManager	BshClassManager
    //   151	291	21	localNameSpace2	NameSpace
    //   191	39	23	arrayOfVariable	Variable[]
    //   204	28	24	arrayOfDelayedEvalBshMethod	DelayedEvalBshMethod[]
    //   208	16	25	str4	String
    //   212	288	26	str5	String
    //   216	206	27	str6	String
    //   240	3	28	localClassGeneratorUtil	ClassGeneratorUtil
    //   247	90	29	arrayOfByte	byte[]
    //   254	19	30	str7	String
    //   341	164	32	localClass	Class
    //   331	1	33	localIOException	java.io.IOException
    //   507	23	33	localUtilEvalError	UtilEvalError
    //   516	24	34	localStringBuffer3	StringBuffer
    //   548	1	34	localUnavailable	Capabilities.Unavailable
    //   409	19	39	localStringBuffer4	StringBuffer
    //   432	5	42	str8	String
    //   456	23	43	localException	Exception
    //   465	24	44	localStringBuffer5	StringBuffer
    //   268	39	48	localStringBuffer6	StringBuffer
    //   314	10	53	localFileOutputStream	java.io.FileOutputStream
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\bsh\ClassGeneratorImpl.class
