...
public class JavaCharStream
{
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    throw new Error(((Throwable)localObject).getMessage());
  }
  ...
  public char readChar()
  {
    ...
    //   0	451	0	this	JavaCharStream
    //   61	12	1	i1	int
    //   83	13	2	arrayOfChar1	char[]
    //   88	9	3	i2	int
    //   93	356	4	c1	char
    //   114	321	5	i3	int
    //   122	15	6	i4	int
    //   147	15	7	arrayOfChar2	char[]
    //   153	11	8	i5	int
    //   159	258	9	c2	char
    //   202	9	10	i6	int
    //   347	51	11	localStringBuffer	StringBuffer
    //   229	22	17	c3	char
    //   340	1	17	localIOException1	IOException
    //   242	49	18	arrayOfChar3	char[]
    //   427	1	18	localIOException2	IOException
    //   248	45	19	i7	int
    //   288	26	20	c4	char
    //   23	15	21	i8	int
    // Exception table:
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\bsh\JavaCharStream.class
