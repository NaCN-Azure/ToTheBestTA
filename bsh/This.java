  ...
  implements Serializable, Runnable
{
  ...
  static This a(NameSpace paramNameSpace, Interpreter paramInterpreter)
  {
    try
    {
      ...
      label54:
      This localThis = new This(paramNameSpace, paramInterpreter);
      return localThis;
    }
  ...
  public Object invokeMethod(String paramString, Object[] paramArrayOfObject, Interpreter paramInterpreter, CallStack paramCallStack, SimpleNode paramSimpleNode, boolean paramBoolean)
  {
    ...
    //   0	338	2	paramArrayOfObject	Object[]
    //   0	338	3	paramInterpreter	Interpreter
    //   0	338	4	paramCallStack	CallStack
    //   0	338	5	paramSimpleNode	SimpleNode
    //   0	338	6	paramBoolean	boolean
    //   102	190	7	arrayOfClass	Class[]
    //   116	133	8	localObject1	Object
    //   278	48	10	localStringBuffer	StringBuffer
    //   233	3	15	localBshMethod	BshMethod
    //   121	1	16	localUtilEvalError1	UtilEvalError
    //   188	7	16	localObject2	Object
    //   191	16	17	bool	boolean
    //   242	1	17	localUtilEvalError2	UtilEvalError
    //   9	40	18	arrayOfObject	Object[]
    //   12	44	19	i	int
    //   37	16	20	localObject3	Object
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\bsh\This.class
