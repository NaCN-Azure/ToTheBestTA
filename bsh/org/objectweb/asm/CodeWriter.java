  ...
  implements CodeVisitor
{
  ...
  protected int[] a(int[] paramArrayOfInt1, int[] paramArrayOfInt2, int paramInt)
  {
    ...
    for (;;)
    {
        ...
        if (i2 == 0)
        {
          ...
          if (i16 >= this.h.b)
          {
            if (this.j != null)
            {
              ...
              {
                a(arrayOfByte4, i42, a((int[])localObject4, (int[])localObject3, 0, a(arrayOfByte4, i42)));
                int i43 = i42 + 2;
                a(arrayOfByte4, i43, a((int[])localObject4, (int[])localObject3, 0, a(arrayOfByte4, i43)));
                int i44 = i42 + 4;
                a(arrayOfByte4, i44, a((int[])localObject4, (int[])localObject3, 0, a(arrayOfByte4, i44)));
              }
            }
            if (this.n != null)
            {
              ...
              for (int i39 = 0; i39 < this.n.b; i39 += 10)
              {
                ...
                int i41 = a((int[])localObject4, (int[])localObject3, 0, i40);
                a(arrayOfByte3, i39, i41);
                a(arrayOfByte3, i39, a((int[])localObject4, (int[])localObject3, 0, i40 + a(arrayOfByte3, i39 + 2)) - i41);
              }
            }
            if (this.p != null)
            {
              ...
              for (int i38 = 0; i38 < this.p.b; i38 += 4) {
                a(arrayOfByte2, i38, a((int[])localObject4, (int[])localObject3, 0, a(arrayOfByte2, i38)));
              }
            }
              ...
              for (;;)
              {
                ...
                for (;;)
                {
                  if (localByteVector.b % 4 == 0)
                  {
                    ...
                    int i33 = i31 + 4;
                    localByteVector.put4(a((int[])localObject4, (int[])localObject3, i16, i32));
                    ...
                    for (;;)
                    {
                      ...
                      i35 = i36 + 4;
                      localByteVector.put4(a((int[])localObject4, (int[])localObject3, i16, i37));
                      i34--;
                      i6 = 132;
                    }
                  }
                ...
                for (;;)
                {
                  if (localByteVector.b % 4 == 0)
                  {
                    ...
                    int i25 = i23 + 4;
                    localByteVector.put4(a((int[])localObject4, (int[])localObject3, i16, i24));
                    ...
                    for (;;)
                    {
                      ...
                      i29 += 4;
                      localByteVector.put4(a((int[])localObject4, (int[])localObject3, i16, i30));
                      i28--;
                    }
                  }
                  localByteVector.put1(0);
                }
                int i22 = a((int[])localObject4, (int[])localObject3, i16, i16 + c(arrayOfByte1, i16 + 1));
                ...
                int i20 = a((int[])localObject4, (int[])localObject3, i16, i19 + i16);
      ...
      for (;;)
      {
        ...
        if (i3 == 1)
        {
          i8 = -(i1 & a((int[])localObject4, (int[])localObject3, 0, i4));
        }
        ...
        if (i3 == 1)
        {
          i12 = -(i1 & a((int[])localObject4, (int[])localObject3, 0, i4));
        }
        else if (arrayOfBoolean[i4] == 0)
        {
          i12 = i4 & 0x3;
        ...
        int i10 = a((int[])localObject4, (int[])localObject3, i4, i9 + i4);
        int i11;
  ...
  public void visitJumpInsn(int paramInt, Label paramLabel)
  {
    ...
    if ((paramLabel.a) && (paramLabel.b - this.h.b < 32768))
    {
      ...
      label237:
      paramLabel.a(this, this.h, this.h.b - 1, true);
      return;
    }
    this.h.put1(paramInt);
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\bsh\org\objectweb\asm\CodeWriter.class
