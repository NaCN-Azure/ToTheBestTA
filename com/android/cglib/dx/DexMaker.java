...
public final class DexMaker
{
  ...
  private ClassLoader a(File paramFile1, File paramFile2, ClassLoader paramClassLoader)
  {
    ...
    //   0	134	0	this	DexMaker
    //   0	134	1	paramFile1	File
    //   0	134	2	paramFile2	File
    //   0	134	3	paramClassLoader	ClassLoader
    //   120	9	4	localClassNotFoundException	ClassNotFoundException
    //   105	7	5	localInvocationTargetException	java.lang.reflect.InvocationTargetException
    //   32	35	6	localConstructor	java.lang.reflect.Constructor
    //   38	31	7	arrayOfObject	Object[]
    //   76	3	8	localClassLoader	ClassLoader
    //   81	1	9	localIllegalAccessException	IllegalAccessException
    //   89	1	10	localNoSuchMethodException	NoSuchMethodException
    //   97	1	11	localInstantiationException	InstantiationException
    // Exception table:
    //   from	to	target	type
  ...
  public void declare(TypeId<?> paramTypeId1, String paramString, int paramInt, TypeId<?> paramTypeId2, TypeId<?>... paramVarArgs)
  {
    ...
    c.a(localc, new TypeList(paramVarArgs));
  }
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\android\cglib\dx\DexMaker.class
