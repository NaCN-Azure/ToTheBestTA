...
class a
{
  ...
  private String a(ClassLoader paramClassLoader, Class<?> paramClass)
  {
    ...
    //   0	33	0	this	a
    //   0	33	1	paramClassLoader	ClassLoader
    //   0	33	2	paramClass	Class<?>
    //   6	7	3	localField	java.lang.reflect.Field
    //   20	3	4	str	String
    //   25	1	5	localNoSuchFieldException	NoSuchFieldException
    // Exception table:
    //   from	to	target	type
  ...
  public File a()
  {
    ...
    //   start	length	slot	name	signature
    //   0	46	0	this	a
    //   4	16	1	localClassLoader	ClassLoader
    //   10	11	2	localClass	Class
    //   27	9	4	arrayOfFile	File[]
    //   39	3	5	localFile	File
    //   44	1	5	localClassCastException	ClassCastException
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\android\cglib\dx\a.class
