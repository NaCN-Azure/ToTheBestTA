    ...
    for (int k = 0; k < i; k++)
    {
      ...
      if (localb.g())
      {
        ...
        if (((c)localObject3).a() != 0)
        {
          ...
          if (((c)localObject3).a() != 0) {
            localArrayList.add(a((com.android.cglib.dx.c.b.b)localObject1, (com.android.cglib.dx.c.b.b)localObject2, (c)localObject3, parama));
          }
        }
        localObject1 = localb;
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\android\cglib\dx\a\a\y.class
