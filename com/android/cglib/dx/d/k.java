  ...
  extends o
{
  ...
  public k(int paramInt)
  {
    ...
    //   0	33	0	this	k
    //   0	33	1	paramInt	int
    //   23	1	2	localNegativeArraySizeException	NegativeArraySizeException
    // Exception table:
    //   from	to	target	type
  ...
  public int a(int paramInt)
  {
    ...
    //   0	37	1	paramInt	int
    //   24	2	2	i	int
    //   27	1	3	localArrayIndexOutOfBoundsException	ArrayIndexOutOfBoundsException
    // Exception table:
    //   from	to	target	type
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    //   start	length	slot	name	signature
    //   0	50	0	this	k
    //   0	50	1	paramInt1	int
    //   0	50	2	paramInt2	int
    //   35	1	3	localArrayIndexOutOfBoundsException	ArrayIndexOutOfBoundsException
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\android\cglib\dx\d\k.class
