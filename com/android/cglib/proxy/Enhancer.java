...
public class Enhancer
{
  ...
  private <S> void a(DexMaker paramDexMaker, TypeId<?> paramTypeId, TypeId<S> paramTypeId1)
  {
    ...
    Object localObject2 = TypeId.get(Object[].class);
    ...
    while (j < i)
    {
      ...
      if (((0x8 & localConstructor.getModifiers()) == 0) && ((0x10 & localConstructor.getModifiers()) == 0))
      {
        ...
        try
        {
          a(paramDexMaker, paramTypeId, paramTypeId1, localConstructor, (FieldId)localObject12);
        }
    ...
    localCode1.iput((FieldId)localObject5, localCode1.getThis(paramTypeId1), localCode1.getParameter(0, localTypeId1));
    ...
    Local localLocal2 = localCode2.newLocal((TypeId)localObject6);
    Local localLocal3 = localCode2.getThis(paramTypeId1);
    localCode2.invokeVirtual(paramTypeId1.getMethod((TypeId)localObject6, "getClass", new TypeId[0]), localLocal2, localLocal3, new Local[0]);
    ...
    while (k < m)
    {
      ...
      if ((!str.contains("_Enhancer")) && (!str.contains("_Super")) && ((0x8 & localMethod.getModifiers()) == 0) && ((0x10 & localMethod.getModifiers()) == 0) && ((0x100 & localMethod.getModifiers()) == 0) && (((0x400 & localMethod.getModifiers()) != 0) || (this.d == null) || (this.d.filter(localMethod, str)))) {
        try
        {
          a(paramDexMaker, paramTypeId, paramTypeId1, localMethod, str, (FieldId)localObject5);
        }
  ...
  private void a(DexMaker paramDexMaker, TypeId<?> paramTypeId1, TypeId<?> paramTypeId2, Method paramMethod, String paramString, FieldId<?, MethodInterceptor> paramFieldId)
  {
    ...
    Code localCode1 = paramDexMaker.declare(localMethodId1, 0xFBFF & paramMethod.getModifiers());
    ...
    if (i != 0)
    {
      ...
      while (k < localObject1.length)
      {
        ...
        if (localObject1[k].isPrimitive())
        {
          ...
          localCode1.invokeStatic(localMethodId6, (Local)localObject8, arrayOfLocal3);
          localCode1.aput(localLocal10, localLocal4, (Local)localObject8);
        }
        else
        {
          localObject6 = localObject2;
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\android\cglib\proxy\Enhancer.class
