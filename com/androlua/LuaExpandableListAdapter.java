  ...
  extends BaseExpandableListAdapter
{
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, android.view.ViewGroup paramViewGroup)
  {
    ...
    //   0	398	0	this	LuaExpandableListAdapter
    //   0	398	1	paramInt1	int
    //   0	398	2	paramInt2	int
    //   0	398	3	paramBoolean	boolean
    //   0	398	4	paramView	View
    //   0	398	5	paramViewGroup	android.view.ViewGroup
    //   16	217	6	localLuaTable1	LuaTable
    //   60	336	7	localView1	View
    //   131	47	8	localLuaTable2	LuaTable
    //   145	21	9	localStringBuilder	StringBuilder
    //   187	13	13	localIterator	Iterator
    //   310	81	14	localObject1	Object
    //   356	1	15	localException1	Exception
    //   365	5	15	localException2	Exception
    //   331	28	17	localAnimation	Animation
    //   352	3	18	localException3	Exception
    //   209	15	20	localEntry	Map.Entry
    //   260	5	21	localException4	Exception
    //   72	1	23	localLuaException	LuaException
    //   221	14	23	str	String
    //   230	23	24	localObject2	Object
    //   242	9	25	localView2	View
    //   22	29	26	localLuaFunction	LuaFunction
    //   28	25	27	arrayOfObject	Object[]
    // Exception table:
    //   from	to	target	type
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, android.view.ViewGroup paramViewGroup)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	380	0	this	LuaExpandableListAdapter
    //   0	380	1	paramInt	int
    //   0	380	2	paramBoolean	boolean
    //   0	380	3	paramView	View
    //   0	380	4	paramViewGroup	android.view.ViewGroup
    //   15	203	5	localLuaTable1	LuaTable
    //   59	319	6	localView1	View
    //   116	47	7	localLuaTable2	LuaTable
    //   130	21	8	localStringBuilder	StringBuilder
    //   172	13	12	localIterator	Iterator
    //   293	80	13	localObject1	Object
    //   338	1	14	localException1	Exception
    //   347	5	14	localException2	Exception
    //   314	27	16	localAnimation	Animation
    //   334	3	17	localException3	Exception
    //   194	15	19	localEntry	Map.Entry
    //   245	5	20	localException4	Exception
    //   71	1	22	localLuaException	LuaException
    //   206	14	22	str	String
    //   215	23	23	localObject2	Object
    //   227	9	24	localView2	View
    //   21	29	25	localLuaFunction	LuaFunction
    //   27	25	26	arrayOfObject	Object[]
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\androlua\LuaExpandableListAdapter.class
