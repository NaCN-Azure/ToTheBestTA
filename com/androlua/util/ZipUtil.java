...
public class ZipUtil
{
  ...
  private static void a(File paramFile, ZipOutputStream paramZipOutputStream, String paramString)
  {
    ...
    //   0	275	1	paramZipOutputStream	ZipOutputStream
    //   0	275	2	paramString	String
    //   4	5	3	bool	boolean
    //   6	263	4	i	int
    //   233	26	5	arrayOfFile	File[]
    //   249	7	6	j	int
    //   13	173	7	localObject1	Object
    //   34	171	8	localObject2	Object
    //   137	1	9	localFileNotFoundException1	java.io.FileNotFoundException
    //   173	3	9	localFileNotFoundException2	java.io.FileNotFoundException
    //   191	3	10	localIOException1	java.io.IOException
    //   123	1	11	localObject3	Object
    //   146	74	11	localObject4	Object
    //   212	3	12	localIOException2	java.io.IOException
    //   128	1	13	localIOException3	java.io.IOException
    //   155	3	13	localIOException4	java.io.IOException
    //   44	7	14	k	int
    //   55	16	15	str	String
    //   91	14	16	m	int
    // Exception table:
  ...
  public static boolean unzip(File paramFile, String paramString)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	537	0	paramFile	File
    //   0	537	1	paramString	String
    //   59	40	2	localFile1	File
    //   119	356	3	localObject1	Object
    //   164	356	4	localObject2	Object
    //   420	1	5	localFileNotFoundException1	java.io.FileNotFoundException
    //   460	3	5	localFileNotFoundException2	java.io.FileNotFoundException
    //   382	118	6	bool	boolean
    //   486	20	7	localLogger1	Logger
    //   490	20	8	str1	String
    //   397	3	9	localIOException1	java.io.IOException
    //   407	1	10	localObject3	Object
    //   428	107	10	localObject4	Object
    //   527	3	11	localIOException2	java.io.IOException
    //   412	1	12	localIOException3	java.io.IOException
    //   436	3	12	localIOException4	java.io.IOException
    //   171	8	13	localZipEntry	ZipEntry
    //   183	29	14	str2	String
    //   192	26	15	localStringBuilder1	StringBuilder
    //   222	98	19	str3	String
    //   244	38	20	localFile2	File
    //   331	43	21	localBufferedOutputStream	java.io.BufferedOutputStream
    //   346	15	22	i	int
    //   269	34	23	localStringBuilder2	StringBuilder
    //   77	30	27	localLogger2	Logger
    //   86	23	28	localStringBuilder3	StringBuilder
    //   10	30	31	localLogger3	Logger
    //   19	23	32	localStringBuilder4	StringBuilder
    // Exception table:
    //   from	to	target	type
  ...
  public static boolean zip(String paramString1, String paramString2)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	480	0	paramString1	String
    //   0	480	1	paramString2	String
    //   8	293	2	localFile1	File
    //   103	35	3	localStringBuilder1	StringBuilder
    //   144	124	8	localFile2	File
    //   249	214	9	localObject1	Object
    //   288	72	10	localZipOutputStream	ZipOutputStream
    //   357	1	11	localFileNotFoundException1	java.io.FileNotFoundException
    //   371	3	11	localFileNotFoundException2	java.io.FileNotFoundException
    //   308	120	12	bool	boolean
    //   414	20	13	localLogger1	Logger
    //   418	20	14	str1	String
    //   394	3	15	localIOException1	java.io.IOException
    //   338	3	16	localIOException2	java.io.IOException
    //   348	1	17	localObject2	Object
    //   366	112	17	localObject3	Object
    //   455	3	18	localIOException3	java.io.IOException
    //   470	3	19	localIOException4	java.io.IOException
    //   323	3	20	localIOException5	java.io.IOException
    //   19	193	21	localLogger2	Logger
    //   28	195	22	localStringBuilder2	StringBuilder
    //   39	197	24	str2	String
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\androlua\util\ZipUtil.class
