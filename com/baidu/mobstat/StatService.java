...
public class StatService
{
  ...
  private static String a(boolean paramBoolean)
  {
    ...
    //   0	87	0	paramBoolean	boolean
    //   6	10	1	arrayOfStackTraceElement	StackTraceElement[]
    //   8	71	2	i	int
    //   21	12	3	str	String
    //   36	37	4	localClass	Class
    //   41	1	5	localThrowable	Throwable
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\baidu\mobstat\StatService.class
