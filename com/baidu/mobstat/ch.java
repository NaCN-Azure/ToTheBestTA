...
class ch
{
  ...
  private int i()
  {
    ...
    //   0	157	0	this	ch
    //   5	119	1	localClass1	Class
    //   16	123	2	localClass2	Class
    //   28	21	3	arrayOfStackTraceElement	StackTraceElement[]
    //   30	120	4	i1	int
    //   46	41	5	str1	String
    //   55	19	6	str2	String
    //   91	49	7	localClass3	Class
    //   9	1	8	localClassNotFoundException1	ClassNotFoundException
    //   20	1	9	localClassNotFoundException2	ClassNotFoundException
    //   96	1	10	localThrowable	Throwable
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\baidu\mobstat\ch.class
