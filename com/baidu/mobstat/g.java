...
public final class g
{
  ...
  private static String a(File paramFile)
  {
    ...
    //   8	116	1	localFileReader	FileReader
    //   84	1	2	localObject1	Object
    //   118	18	2	localObject2	Object
    //   130	2	3	localException1	Exception
    //   79	1	4	localException2	Exception
    //   90	5	4	localException3	Exception
    //   109	3	5	localException4	Exception
    //   14	27	6	arrayOfChar	char[]
    //   23	29	7	localCharArrayWriter	java.io.CharArrayWriter
    //   31	13	8	i	int
    //   56	21	9	str	String
    //   69	3	10	localException5	Exception
    // Exception table:
    //   from	to	target	type
  ...
  private List<i> a(Intent paramIntent, boolean paramBoolean)
  {
    ...
    //   start	length	slot	name	signature
    //   0	439	0	this	g
    //   0	439	1	paramIntent	Intent
    //   0	439	2	paramBoolean	boolean
    //   7	425	3	localArrayList	java.util.ArrayList
    //   15	251	4	localPackageManager	android.content.pm.PackageManager
    //   24	8	5	localList	List
    //   38	17	6	localIterator	Iterator
    //   64	204	7	localResolveInfo	android.content.pm.ResolveInfo
    //   119	130	8	localBundle	android.os.Bundle
    //   136	14	9	str1	String
    //   159	210	11	arrayOfByte1	byte[]
    //   177	109	12	localJSONObject	org.json.JSONObject
    //   187	222	13	locali	i
    //   255	97	14	str2	String
    //   283	55	16	localPackageInfo	android.content.pm.PackageInfo
    //   292	28	17	localJSONArray	org.json.JSONArray
    //   302	33	18	arrayOfString	String[]
    //   305	23	19	i	int
    //   366	15	20	arrayOfByte2	byte[]
    //   43	1	21	localException	Exception
    //   373	10	21	arrayOfByte3	byte[]
    //   391	44	22	j	int
    // Exception table:
    //   from	to	target	type
  ...
  private void a()
  {
    ...
    //   start	length	slot	name	signature
    //   0	92	0	this	g
    //   10	72	1	localByteArrayInputStream	java.io.ByteArrayInputStream
    //   86	2	3	localException1	Exception
    //   37	1	4	localObject1	Object
    //   48	21	4	localObject2	Object
    //   61	3	5	localException2	Exception
    //   42	5	6	localObject3	Object
    //   71	1	7	localException3	Exception
    //   76	1	8	localException4	Exception
    // Exception table:
    //   from	to	target	type
    //   11	28	37	finally
    //   0	11	42	finally
  ...
  private boolean a(String paramString)
  {
    ...
    //   113	50	6	localObject3	Object
    //   155	3	7	localException4	Exception
    //   28	80	8	localFileOutputStream	java.io.FileOutputStream
    //   57	3	9	localException5	Exception
    // Exception table:
    //   from	to	target	type
  ...
  private String h(String paramString)
  {
    ...
    String str1 = i((String)localObject);
    if (TextUtils.isEmpty(str1)) {
      return paramString;
    }
    return str1;
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\baidu\mobstat\g.class
