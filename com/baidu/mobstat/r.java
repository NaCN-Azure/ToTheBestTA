...
class r
{
  ...
  private void b(Context paramContext, boolean paramBoolean)
  {
    ...
    //   4	114	3	localPackageManager	android.content.pm.PackageManager
    //   18	33	4	localObject	Object
    //   34	3	5	localException1	Exception
    //   48	185	6	localJSONArray	JSONArray
    //   57	13	7	localIterator	java.util.Iterator
    //   173	70	8	localStringBuilder1	StringBuilder
    //   182	22	9	localStringBuilder2	StringBuilder
    //   226	26	14	localJSONObject	JSONObject
    //   262	28	15	str1	String
    //   282	6	16	l	long
    //   267	1	19	localException2	Exception
    //   79	69	22	localPackageInfo	PackageInfo
    //   86	43	23	localApplicationInfo	android.content.pm.ApplicationInfo
    //   107	32	24	bool	boolean
    //   126	18	25	str2	String
    //   133	13	26	str3	String
    //   25	3	27	localList	java.util.List
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\baidu\mobstat\r.class
