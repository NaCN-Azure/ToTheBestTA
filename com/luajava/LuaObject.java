  ...
  implements Serializable
{
  ...
  protected void finalize()
  {
    ...
    //   0	84	0	this	LuaObject
    //   49	27	1	localPrintStream	java.io.PrintStream
    //   57	20	2	localStringBuilder	StringBuilder
    //   46	1	5	localException	Exception
    //   38	6	6	localObject	Object
    // Exception table:
    //   from	to	target	type
    //   9	34	38	finally
    //   34	37	38	finally
  ...
  public void setField(String paramString, Object paramObject)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	41	0	this	LuaObject
    //   0	41	1	paramString	String
    //   0	41	2	paramObject	Object
    //   15	1	3	localLuaException	LuaException
    // Exception table:
    //   from	to	target	type
  ...
  public String toString()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	167	0	this	LuaObject
    //   4	156	1	localLuaState	LuaState
    ...
    //   55	5	5	str3	String
    //   34	5	6	str4	String
    //   155	1	8	localLuaException	LuaException
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\程序\作业\送给最好的TA_dex2jar.jar!\com\luajava\LuaObject.class
